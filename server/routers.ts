...
export const appRouter = router({
  ...
  bookings: router({
    create: publicProcedure.input(z.object({
      ...
      fullName: z.string(), email: z.string().email(), phone: z.string(), dob: z.string().optional(),
